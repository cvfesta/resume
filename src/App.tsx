...
const App: React.FC = () => {
    ...
    return (
        <Routes>
            ...
            <Route path="/print/full" element={<PrintablePage variant="corporateFull" />} />
            <Route path="/print/c2c/full" element={<PrintablePage variant="contractFull" />} />
